...
char *tableMotsClefs[] = {"si", "alors", "sinon", "tantque", "pour", "faire", "entier", "retour", "lire", "ecrire"};
int codeMotClefs[] = {SI, ALORS, SINON, TANTQUE, POUR, FAIRE, ENTIER, RETOUR, LIRE, ECRIRE};
int nbMotsClefs = 10;
